...
public class PurchaseRequisition {
    ...
    public static void createPurchaseRequisition() {
        ...
        do{
            ...
            System.out.print("\nPlease enter the item that you wish to restock: I");
    ...
    public static void readPurchaseRequisition(){
        ArrayList<PurchaseRequisition> prList = FileAccess.ReadFromTextFile(PurchaseRequisition.class);
        System.out.println("\n ~ ~ P R   D E T A I L S ~ ~\n");
