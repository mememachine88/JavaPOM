        ...
        for (String line: contentString){
            ...
            try {
                switch (objectType.getSimpleName()) {
                    case "User" -> objectList.add(objectType.getConstructor(String.class,String.class,String.class,String.class,String.class,String.class,String.class)
                                .newInstance(info[0],info[1],info[2],info[3],info[4],info[5],info[6]));
                    case "Item" -> objectList.add(objectType.getConstructor(String.class, String.class, double.class, String.class)
                                .newInstance(info[0], info[1], Double.parseDouble(info[2]), info[3]));
                    case "Stock" -> objectList.add(objectType.getConstructor(String.class, String.class, String.class, String.class, String.class, String.class, double.class, int.class, int.class, String.class)
                    ...
                    case "Supplier" -> objectList.add(objectType.getConstructor(String.class, String.class, String.class, double.class, String.class)
                                .newInstance(info[0], info[1], info[2], Double.parseDouble(info[3]), info[4]));
                    case "dailySales" -> objectList.add(objectType.getConstructor(String.class, String.class, int.class, double.class)
                                .newInstance(info[0], info[1], Integer.parseInt(info[2]),Double.parseDouble(info[3])));
                    case "ActionHistory" -> objectList.add(objectType.getConstructor(String.class, String.class,String.class)
