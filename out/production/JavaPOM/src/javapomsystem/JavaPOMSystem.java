...
public class JavaPOMSystem {
    ...
    private static void addNewUser(){
        ...
        switch(choice){
            case "1" -> { role = "Admin"; title = "A D M I N"; }
            case "2" -> { role = "Sales"; title = "S A L E S"; }
            case "3" -> { role = "Purchasing"; title = "P U R C H A S I N G"; }
            case "0" -> {}
            default -> System.out.println("\n(SYSTEM) Invalid selection! Please try again!");
        }
    ...
    public static void editDailySales(boolean isDelete){
        ...
        switch(choice){
            ...
            default -> {isValidSelection = false; System.out.println("\n(SYSTEM) Invalid selection! Please try again!");}
        }
    ...
    private static void purchasingInterface(){
        ...
        do{
            ...
            switch (selection) {
                ...
                case "3" -> Item.displaySpecificSupplierItems();
                case "4" -> Item.displayItemSuppliers();
